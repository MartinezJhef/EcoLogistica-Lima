...
| **Campo** | **Detalle** |
|---|---|
| **Nombre del Director** | **Zayuri Anahí Cerrón Medina** |
| **Rol Asignado** | Directora de Proyecto (*Project Manager*) |
| **Responsabilidades Principales** | • Liderar la planificación, ejecución y control del proyecto (16 semanas). |

### Nivel de autoridad

Poder de decisión resolutivo e integral sobre la arquitectura tecnológica, metodologías y gestión interna.
